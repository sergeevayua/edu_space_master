 ...
 * @author agerus
 */
public abstract class AbstractGetController<PK extends Serializable, T extends BaseEntity> extends AbstractController<T> {

    protected abstract EntityService<PK, T> getService();

    @RequestMapping(value = "/", method = GET, produces = APPLICATION_JSON_VALUE)
    public Collection<T> getAll(Principal principal) {
    ...
    public T getOne(@PathVariable PK id, Principal principal) {
