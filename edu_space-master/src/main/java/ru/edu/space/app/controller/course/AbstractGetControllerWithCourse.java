 ...
 * @author agerus
 */
public abstract class AbstractGetControllerWithCourse<PK extends Serializable, T extends BaseEntity> extends AbstractController<T> {

    protected abstract EntityService<PK, T> getService();

    @RequestMapping(value = "/", method = GET, produces = APPLICATION_JSON_VALUE)
    public Collection<T> getAll(@PathVariable Long courseGroupId, @PathVariable Long courseId, Principal principal) {
    ...
    public T getOne(@PathVariable PK id, @PathVariable Long courseGroupId, @PathVariable Long courseId, Principal principal) {
